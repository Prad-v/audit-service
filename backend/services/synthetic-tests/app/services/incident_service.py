"""
Incident Service for Synthetic Tests

This service handles incident creation when synthetic tests fail.
"""
...
class IncidentService:
    """Service for creating incidents when synthetic tests fail"""
    ...
    async def create_incident(self, incident_data: Dict[str, Any]) -> str:
        ...
        payload = {
            "title": incident_data.get("title", "Synthetic Test Failure"),
            "description": incident_data.get("description", "A synthetic test has failed"),
            "severity": incident_data.get("severity", "medium"),
            "incident_type": incident_data.get("incident_type", "synthetic_test_failure"),
            "affected_services": incident_data.get("affected_services", ["synthetic-testing"]),
            ...
            "internal_notes": incident_data.get("internal_notes", "Incident created automatically by synthetic test framework"),
            "tags": incident_data.get("tags", ["synthetic-test", "automated"]),
    ...
    async def resolve_incident(self, incident_id: str, resolution_notes: str = "") -> bool:
        ...
        update_data = {
            ...
            "internal_notes": f"Incident resolved automatically by synthetic test framework. {resolution_notes}"
        }
